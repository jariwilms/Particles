...
clEnqueueWaitSemaphoresKHR(cl_command_queue command_queue,
                              ...
                              const cl_semaphore *sema_objects,
...
extern CL_API_ENTRY cl_int CL_API_CALL
clGetSemaphoreInfoKHR(const cl_semaphore sema_object,
...
extern CL_API_ENTRY cl_int CL_API_CALL
clRetainSemaphoreKHR(cl_semaphore sema_object) CL_API_SUFFIX__VERSION_1_2;
...
typedef cl_bitfield cl_semaphore_handle_type_khr;
// API-agnostic semaphore handles are defined here in this spec.
#define CL_SEMAPHORE_HANDLE_TYPE_OPAQUE_FD_KHR                      (1<<0)
#define CL_SEMAPHORE_HANDLE_TYPE_OPAQUE_WIN32_KHR                   (1<<1)
#define CL_SEMAPHORE_HANDLE_TYPE_OPAQUE_WIN32_KMT_KHR               (1<<2)

typedef struct _cl_semaphore_desc_khr_st {
    cl_semaphore_handle_type_khr type;
    void *handle_ptr;
} cl_semaphore_desc_khr;

extern CL_API_ENTRY cl_int CL_API_CALL
clGetSemaphoreHandleForTypeKHR(
    const cl_semaphore sema_object,
    const cl_device_id device,
    cl_semaphore_handle_type_khr handleType,
    void *handle,
...
// error codes
#define CL_INVALID_SEMAPHORE_DESC_KHR                           -1139
#define CL_INVALID_SEMAPHORE_HANDLE_KHR                         -113A
#define CL_INVALID_SEMAPHORE_HANDLE_TYPE_KHR                    -113B

/******************************************
* cl_khr_external_sharing extension *
******************************************/
...
typedef cl_bitfield cl_external_mem_handle_type_khr;
// API-agnostic memory handles are defined here in this spec.
#define CL_EXTERNAL_MEMORY_HANDLE_TYPE_OPAQUE_FD_KHR            (1<<0)
#define CL_EXTERNAL_MEMORY_HANDLE_TYPE_OPAQUE_WIN32_KHR         (1<<1)
#define CL_EXTERNAL_MEMORY_HANDLE_TYPE_OPAQUE_WIN32_KMT_KHR     (1<<2)

typedef cl_bitfield cl_device_external_mem_properties_khr;
#define CL_DEVICE_NON_DEDICATED_EXTERNAL_MEMORY_KHR             (1<<0)
